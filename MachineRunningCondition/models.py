...
#
# # 设备运行状况界面信息
# class machineRunningCondition(models.Model):
#     machine_id = models.ForeignKey(, db_constraint=True, null=True, on_delete=models.CASCADE())  # 机床id
#     monitor_start_status = models.BooleanField(default=False)  # 全部开始监测状态
...
#     sensor_id = models.ForeignKey(, db_constraint=True, null=True, on_delete=models.CASCADE())  # 传感器id
