...
def ZM_remaining_life(c1_id, c2_id, c3_id, c4_id, c5_id, c6_id):
    ...
    x_axis = list(range(0, 3001, 30))
    y_axis = [100, 99, 97, 96, 94, 93, 91, 90, 89, 87, 86, 85, 83, 82, 81, 80, 79, 77, 76, 75, 74, 73, 72, 71, 70, 69,
              68, 67, 66, 65, 64, 63, 62, 61, 61, 60, 59, 58, 57, 57, 56, 55, 55, 54, 53, 53, 52, 52, 51, 51, 50, 50,
              49, 49, 48, 48, 47, 47, 47, 46, 46, 46, 45, 45, 45, 45, 44, 44, 44, 44, 43, 43, 43, 42, 42, 41, 40, 39,
              38, 37, 36, 34, 32, 30, 29, 27, 25, 22, 20, 19, 17, 15, 13, 12, 10, 8, 6, 4, 3, 2, 0]
    ...
    index1 = y_axis.index(current_life) + round(date_gap / 30)
