...
save_folder = "C:/Users/wzy/Desktop/频谱图/所有数据/Z向力信号_时域特征_频域特征_0.2s_0.1_0.5_0.95_add_all"
...
for file_name in os.listdir(folder_path):
    ...
    if file_name.endswith('.csv'):
        ...
        for ratio in ratios:
            ...
            kurt = kurtosis(data_array)  # 峭度
            skewness = skew(data_array)  # 偏度
            ...
            # 将特征加入列表
            features_combined.append([mean_value, std_deviation, rms, kurt, skewness, centroid_freq, freq_variance, mean_freq])
