...
class machineStatus(models.Model):
    id = models.ForeignKey(systemConfig, db_constraint=True, null=True, on_delete=models.CASCADE())  # 机床id
...
class sensorRunningCondition(models.Model):
    id = models.ForeignKey(sensorConfig, db_constraint=True, null=True, on_delete=models.CASCADE())  # 传感器id
